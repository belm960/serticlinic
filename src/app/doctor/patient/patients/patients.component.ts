...
export class PatientsComponent implements OnInit {
  ...
  setid(rowid){
    ...
    window.localStorage.setItem('patient_id',rowid);
  }
  ...
  updatepatient(rowid,vid,room) {
    this.setid(rowid);
    this.setvid(vid,room);
    this.router.navigate(['/vis/visit']).then(e => {
        if (e) {
...
export class ExampleDataSource extends DataSource<Patient> {
  ...
  connect(): Observable<Patient[]> {
    ...
    this._exampleDatabase.getAllInprogressPatients();
