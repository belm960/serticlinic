...
export class HeaderComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    if (userRole === 'Admin') {
      ...
      this.homePage = 'reception/dashboard/main';
    } else if (userRole === 'Opd'){
      this.homePage = 'opd/dashboard/main';
    } else if (userRole === 'Lab'){
      this.homePage = 'laboratory/dashboard/main';
    } else if (userRole === 'Rad'){
      this.homePage = 'radiology/dashboard/main';
    } else if (userRole === 'Room'){
        this.homePage = 'Room/dashboard';
    } else {
      this.homePage = 'patient/dashboard';
    }
  }
