...
export class InprogresspatientsComponent implements OnInit {
  ...
  editCall(row) {
    window.localStorage.removeItem('patient_id_lab_tasted')
    window.localStorage.setItem('patient_id_lab_tasted',row.patient_ID);
    window.localStorage.removeItem('patient_vid_lab_tasted')
    window.localStorage.setItem('patient_vid_lab_tasted',row.v);
    this.router.navigateByUrl('/laboratory/test-result')
  }
...
export class ExampleDataSource extends DataSource<Patient> {
  ...
  connect(): Observable<Patient[]> {
    ...
    this._exampleDatabase.getInprogressPatientsLabTest();
