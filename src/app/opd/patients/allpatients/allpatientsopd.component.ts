...
@Component({
  ...
  templateUrl: './allpatientsopd.component.html',
  styleUrls: ['./allpatientsopd.component.sass'],
})
export class AllpatientsopdComponent implements OnInit {
  displayedColumns = [
    'select',
    'id',
    'sortDate',
  ...
  exampleDatabase: PatientsopdService | null;
  ...
  public loadData() {
    this.exampleDatabase = new PatientsopdService(this.httpClient);
...
export class ExampleDataSource extends DataSource<Patient> {
  ...
  constructor(
    public _exampleDatabase: PatientsopdService,
