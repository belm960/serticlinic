...
import { PatientsService } from 'src/app/reception/patients/allpatients/patients.service';
...
export class OpenpatientsComponent implements OnInit {
  ...
  onSubmit(id: any) {
    ...
    this.httpClient.put(rooturl +'/' + id,{"status":"inprogress"}).subscribe(data =>{
      console.log(data);
      this.showNotification(
        'snackbar-danger',
...
export class ExampleDataSource extends DataSource<Patient> {
  ...
  connect(): Observable<Patient[]> {
    ...
    this._exampleDatabase.getOpenpatients();
