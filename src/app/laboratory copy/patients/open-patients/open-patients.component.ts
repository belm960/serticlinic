...
export class OpenpatientsComponent implements OnInit {
  ...
  editCall(row) {
   /** console.log(this.id);
    ...
    window.localStorage.removeItem('patient_id_rad')
    window.localStorage.setItem('patient_id_rad',row.patient_ID)
    ...
    this.router.navigateByUrl('/radiology/form');
  }
...
export class ExampleDataSource extends DataSource<Patient> {
  ...
  connect(): Observable<Patient[]> {
    ...
    this._exampleDatabase.getInprogressPatientsRadTo();
