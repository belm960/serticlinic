...
@Injectable()
export class PatientsRadService {
  //private readonly API_URL = 'assets/data/patient.json';
  private readonly API_URL = apiUrl+'/pat/rad/Tato';
  ...
  getInprogressPatientsRadTo(): void {
    this.httpClient.get(apiUrl+'/pat/rad/1').subscribe(
        data => {
          this.dataChange.next(data);
          console.log(data);
        },
    ...
    getInprogressPatientsRadTest(): void {
      this.httpClient.get(apiUrl+'/pat/rad/2').subscribe(
          data => {
            this.dataChange.next(data);
            console.log(data);
          },
